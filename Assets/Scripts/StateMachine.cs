...
public class StateMachine : MonoBehaviour
{
    ...
    void Update()
    {
        switch(currentState) //checks current state
        {
   ...
   void OnTriggerExit(Collider other)
    ...
    void Idle()
    {
        ...
        lastPosition = transform.position; //restating position
    }
    
    void Walking()
    {
        Debug.Log("I am walking");
        if (lastPosition == transform.position) //checking if its the same position 
        {
